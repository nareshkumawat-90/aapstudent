...
$query = "
SELECT students.id,students.fname, students.lname, students.email, students.contactno, students.address, students.dob, students.gender, students.class, students.subject, students.total_fee, SUM(fees.amount), students.status  FROM students left join fees  on students.id=fees.student_id GROUP BY students.id,students.fname,students.lname
";
// $query = "
...
if($_POST['query'] != '')
{
  ...
  OR students.total_fee LIKE "%'.str_replace(' ', '%', $_POST['query']).'%"
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <td>'.$row["status"].'</td>
    <td><a class="btn btn-success" href="edit.php?id='.$row["id"].'">Update</a>
    <button class="btn btn-danger delete-btn" data-id='.$row["id"].'>Delete</button>
    <a class="btn btn-success" href="pay.php?id='.$row["id"].'">Fee</a>
    <div class="col-md-6 col-sm-6 col-xs-6">
    <select name="status" data-id='.$row["id"].' class="form-control">
